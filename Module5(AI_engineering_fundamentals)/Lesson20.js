...
// The above one will not work now because the URL will expire after some time.

// SO we can alernatively use the b64_json response format to get base64 encoded image data.
